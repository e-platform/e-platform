...
<title>sshframework</title>

<link href="dwz-ria/themes/default/style.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="dwz-ria/themes/css/core.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="dwz-ria/themes/css/print.css" rel="stylesheet" type="text/css" media="print"/>
<link href="dwz-ria/uploadify/css/uploadify.css" rel="stylesheet" type="text/css" media="screen"/>
<!--[if IE]>
<link href="themes/css/ieHack.css" rel="stylesheet" type="text/css" media="screen"/>
<![endif]-->

<script src="dwz-ria/js/speedup.js" type="text/javascript"></script>
<script src="dwz-ria/js/jquery-1.7.1.js" type="text/javascript"></script>
...
<script src="dwz-ria/xheditor/xheditor-1.1.12-zh-cn.min.js" type="text/javascript"></script>
<script src="dwz-ria/uploadify/scripts/swfobject.js" type="text/javascript"></script>
<script src="dwz-ria/uploadify/scripts/jquery.uploadify.v2.1.0.js" type="text/javascript"></script>
...
$(function(){
	DWZ.init("dwz-ria/dwz.frag.xml", {
		loginUrl:"dwz-ria/login_dialog.html", loginTitle:"登录",	// 弹出登录对话框
//		loginUrl:"login.html",	// 跳到登录页面
		...
		callback:function(){
			initEnv();
			$("#themeList").theme({themeBase:"dwz-ria/themes"}); // themeBase 相对于index页面的主题base路径
		}
	});
});
</script>
				...
				<div class="accordion" fillSpace="sidebar">
					...
					<div class="accordionContent">
						<ul class="tree treeFolder">
							<li><a>主框架面板</a>
								<ul>
									<li><a href="http://www.baidu.com" target="navTab">XXX</a>
								</ul>
							</li>
							<li><a href="#">密码修改</a></li>
						</ul>
